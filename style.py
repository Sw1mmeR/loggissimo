...
class Style:
    ...
    def __init__(self,
        ...
        _success_style = level_style.get(Level.SUCCESS, (Color.GREEN, FontStyle.DEFAULT))
        self.level[Level.SUCCESS] = style(_success_style[0].value, _success_style[1].value)
        ...
        _crit_style = level_style.get(Level.CRITICAL, (Color.MAGENTA, FontStyle.DEFAULT))
